...
public class SportRequest {
    public List<Sport> sportHttp(double longitude, double latitude, int radius) {
        ...
        String url = "https://egs.gate.petersburg.ru/egs/sportgrounds/?count=9&location_latitude=" + longitude +"&location_longitude=" + latitude + "&location_radius=" + radius;
        int count = 0;
        List<Sport> sports = new ArrayList<>();
            ...
            ResponseEntity<SportApiGet> response = restTemplate.exchange(url + "&page=" + 1, HttpMethod.GET, entity, SportApiGet.class);
